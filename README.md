...
--- | --- | --- | ---
`AWS_DEFAULT_REGION` | [AWS Intrinsic](https://docs.aws.amazon.com/lambda/latest/dg/configuration-envvars.html#configuration-envvars-runtime) | String | Used to link maintainers to CloudWatch logs on error.
...
`AWS_REGION` | [AWS Intrinsic](https://docs.aws.amazon.com/lambda/latest/dg/configuration-envvars.html#configuration-envvars-runtime) | String | Used to link maintainers to CloudWatch logs on error.
